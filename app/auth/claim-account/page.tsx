      ...
      <div className={styles.contentWrapper}>
        <div className={styles.card}>
          ...
          <div className={styles.header}>
            <h1 className={styles.title}>Welcome to Yuvara</h1>
            <p className={styles.subtitle}>Complete your account setup by creating a password below.</p>
          </div>
          ...
          {!error && token && (
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              >
                {loading ? "Claiming Account..." : "Create Account"}
              </button>
            </form>
          )}
